...
procedure TDiffUtilBF.BothShows1Click(Sender: TObject);
begin
     DifViewStyle:=2;
     DiffBtnClick(nil);
end;

procedure TDiffUtilBF.Combined1Click(Sender: TObject);
begin
     DifViewStyle:=1;
     DiffBtnClick(nil);
end;

procedure TDiffUtilBF.ContextDiff1Click(Sender: TObject);
begin
     DifFilterStyle:=2;
     DiffBtnClick(nil);
end;

function TDiffUtilBF.ConvertASCStringGrid(Grid: TStringGrid): {$IF DifUtilType=1}TASCStringGrid{$ELSE}TStringGrid{$IFEND};
Var
   N:ASCMRString;
   v:ASCMRString;
...
procedure TDiffUtilBF.CreateParams(var Params: TCreateParams);
begin
     inherited;
...
procedure TDiffUtilBF.DiffBtnClick(Sender: TObject);
const
     DfEsit=0;
     DfKaynakEksik=1;
     DfKaynakFazla=2;
...
procedure TDiffUtilBF.DiffsOnly1Click(Sender: TObject);
begin
     DifFilterStyle:=3;
     DiffBtnClick(nil);
end;

procedure TDiffUtilBF.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     DiffUtilBF:=Nil;

end;

procedure TDiffUtilBF.FormCreate(Sender: TObject);
begin
     floadcancel:=false;
     ContextMaxLine:=5;
     DifFilterStyle:=1;
...
procedure TDiffUtilBF.FormResize(Sender: TObject);
begin
     ResizeTim.Enabled:=True;
end;

procedure TDiffUtilBF.FullDiff1Click(Sender: TObject);
begin
     DifFilterStyle:=1;
     DiffBtnClick(nil);
end;

procedure TDiffUtilBF.Grd1Click(Sender: TObject);
Var
   r1,r2:integer;
   s1,s2:ASCMRString;
begin
...
procedure TDiffUtilBF.Grd1DrawCell(Sender: TObject; ACol, ARow: Integer;
...
procedure TDiffUtilBF.Grd1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TDiffUtilBF.Grd1MouseWheelUp(Sender: TObject; Shift: TShiftState;
  MousePos: TPoint; var Handled: Boolean);
begin
     Grd1Click(Sender);
end;
...
procedure TDiffUtilBF.ASCII80Load(FileDataStr:TMemoryStream;Grid:{$IF DifUtilType=1}TASCStringGrid{$ELSE}TStringGrid{$IFEND});
var
...
procedure TDiffUtilBF.HexLoad(FileDataStr:TMemoryStream;
Grid:{$IF DifUtilType=1}TASCStringGrid{$ELSE}TStringGrid{$IFEND});
var
    s2:String;//ASCMRString;
    buffer:Array [1..200] of Char;//ASCMRChar;
...
procedure TDiffUtilBF.loadcanceltimTimer(Sender: TObject);
begin
     loadcanceltim.Enabled:=False;
     Close;
end;
procedure TDiffUtilBF.NextChange1Click(Sender: TObject);
Var
   i,j:integer;
begin
...
procedure TDiffUtilBF.PreviousChange1Click(Sender: TObject);
Var
   i,j:integer;
begin
...
procedure TDiffUtilBF.RefreshCols;
var
   c:integer;
begin
...
procedure TDiffUtilBF.ResizeTimTimer(Sender: TObject);
begin
     ResizeTim.Enabled:=false;
     RefreshCols;
end;

procedure TDiffUtilBF.LastChange1Click(Sender: TObject);
Var
   i,j:integer;
begin
...
procedure TDiffUtilBF.FirstChange1Click(Sender: TObject);
Var
   i,j:integer;
begin
...
procedure TDiffUtilBF.PasteBtnClick(Sender: TObject);
Var
...
procedure TDiffUtilBF.ToolButton5Click(Sender: TObject);
var
...
procedure TDiffUtilBF.ShellOpenBtnClick(Sender: TObject);
var
   msj:String;
   f,msk,s:string;
begin
...
procedure TDiffUtilBF.CloseBtnClick(Sender: TObject);
begin
     Close;
end;
